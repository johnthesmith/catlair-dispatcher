...
`I` - количество инстансов данного типа;
`k` - коэффициент запаса от 0 - запаса нет, 1 - полное дублирование на все 
инстансы).
...
```
P = C × ( 1 + D × 2 ) / max( 1, I * ( 1 - k ))
```
### Расчет количество php-fpm распределенная схема
